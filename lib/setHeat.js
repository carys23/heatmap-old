...
function vauleOutputOne(dataPointOne)
{
    ...
    if (value < 5){
        ...
        const intensity9000 = 90000;
        console.log(intensity9000)
        return intensity9000
                            }
...
function vauleOutputThree(dataPointThree)
{
    var value = dataPointThree.length;
    console.log('dataPointThree is: ', value)
...
dataPointThree = vauleOutputThree(dataPointThree)